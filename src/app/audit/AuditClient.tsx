...
export default function AuditClient() {
  ...
  // Group consecutive entries by session for readability.
  ...
  function exportCsv() {
    const header = ['日時', 'ブレイン', '役割', '内容', '上長確認', 'セッション', '利用者'];
    ...
    <div className="space-y-6">
      ...
      <header>
        ...
        <p className="mt-2 max-w-2xl text-sm leading-relaxed text-neutral-500">
          すべてのブレインへの質問と回答の記録です。会話はブラウザ内にも
          残りますが、こちらは組織として残る恒久的な記録です。
        </p>
      </header>
            ...
            >
              <div className="flex items-center justify-between border-b border-neutral-100 bg-neutral-50 px-4 py-2 text-[11px] text-neutral-500">
                ...
                <span>
                  ...
                  {g.session && ` ・ セッション ${g.session.slice(0, 8)}`}
                </span>
              </div>
