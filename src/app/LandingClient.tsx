...
const DEMO_PERSONAS: DemoPersona[] = [
  {
    ...
    qa: [
      ...
      {
        q: '接待費の勘定科目は?',
        a: '接待費は基本的に「交際費」勘定で処理します。ただし社内の慰労会など、社外の人物が含まれない場合は「福利厚生費」になります。1 人 10,000 円以下の飲食費は「会議費」として交際費から除外できます(2024 年 4 月の税制改正で 5,000 円から引き上げ)。',
      },
      {
        q: '海外出張のレート換算は?',
    ...
    <section className="lp-sect-soft py-24 sm:py-28">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <p className="mt-4 text-center text-xs text-neutral-500">
          ※ 本セクションの数値は導入時に設定する目標値の例です。導入後は監査ログの質問件数などから実測して振り返れます。
        </p>
